...
function paint(active=-1, passive=-1, sorted=[]) {
  ...
  for (let i = 0; i < arr.length; i ++) {    
    ...
    //child.style.background = "linear-gradient(to top, #f5f5f5 0%, #e5e5e5 25%, #b5b5b5 50%, #d5d5d5 75%, #959595 100%)";        
    child.style.background = "linear-gradient(to bottom, #999999 0%, #c8c8c8 50%, #f8f8f8 100%)";
