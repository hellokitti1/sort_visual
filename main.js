...
function paint(active=-1, passive=-1, sorted=[]) {
  ...
  for (let i = 0; i < arr.length; i ++) {    
    ...
    child.style.backgroundColor = "rgba(126, 204, 198, 0.85)"; //#1e6a79  183b94 97ccc8
    //child.style.boxShadow = "0 0 4px rgba(0,0,0,0.5)";
    
    if (sorted.includes(i)) {
      child.style.backgroundColor = "#5dd473";
    }
    
    if (i == active) {
      child.style.backgroundColor = "#ff4545"; //ca1185 ff4545
    }
    
    if (i == passive) {
      child.style.backgroundColor = "#e3dc5f";
    }
